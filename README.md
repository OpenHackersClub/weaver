...
- Effect-TS — commands, plugins, AI workflows, sync orchestration, *and* ephemeral UI state via `SubscriptionRef` ([ADR 0006](./specs/adr/0006-ui-state-effect-over-valtio.md))
